     ...
     &                                                               500
      character(len=4),parameter :: fp_reserved_tokens(17) = 
     &  ['**  ','exp ','log ','sin ','cos ','tan ','mod ','min ',
     &   'max ','abs ','sqrt','+   ','-   ','*   ','div ','(   ', 
     &   ')   ']
        
      integer(kind=int32),parameter :: fp_num_operand(17) = 
     &  [ 2    , 1    , 1    , 1    , 1    , 1    , 2    , 2    ,
     &    2    , 1    ,  1   , 2    ,  2   ,  2   ,  2   ,  0   , 
     &    0    ]
     ...
     &                               fp_reserve_stack(fp_max_stack_size)
      ...
      character(len=fp_token_max_size) :: fp_known_functions(11) = 
